      ...
      <div className="w-full">
        <div className="w-screen h-[50vh] relative">
          ...
          <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
            <h2 className="py-2 text-white">wikky Chat</h2>
            <h3 className="text-white">React JS / Sass / Firebase</h3>
          </div>
        </div>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
          <div className="col-span-4">
            ...
            <a href="https://github.com/BalogunVictor/wikky-chat" target="_blank" rel="noreferrer" className="px-6">
              <CustomButton>Code</CustomButton>
            </a>
            <a
              href="https://wikky-chat.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
